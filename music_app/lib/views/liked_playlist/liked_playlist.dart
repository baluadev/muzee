...
class LikedPlaylist extends StatefulWidget {
  const LikedPlaylist({super.key});

  @override
  State<LikedPlaylist> createState() => _LikedPlaylistState();
}

class _LikedPlaylistState extends State<LikedPlaylist> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: locale.likedSongs),
      body: Padding(
