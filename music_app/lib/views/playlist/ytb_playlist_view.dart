...
class YtbPlaylistView extends StatefulWidget {
  const YtbPlaylistView({super.key});

  @override
  State<YtbPlaylistView> createState() => _YtbPlaylistViewState();
}

class _YtbPlaylistViewState extends State<YtbPlaylistView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: 'Youtube ${locale.playlists.capitalize()}',
      ),
      body: Padding(
  ...
  Future<void> _importPlaylist() async {
    await DialogHelper.showImportPlaylistYtbDialog();
  }
}
