...
Widget _continueGameButton(BuildContext context) {
  return ScopedModelDescendant<SudokuState>(builder: (context, child, state) {
    String buttonLabel = SudokuLocalizations.of(context).menuContinueGame;
...
Widget _newGameButton(BuildContext context) {
  return _buttonWrapper(
      ...
      (_) => CupertinoButton(
          color: Colors.blue,
          child: Text(
            SudokuLocalizations.of(context).menuNewGame,
          ...
          onPressed: () {
            ...
            Widget cancelButton = SizedBox(
                ...
                child: Container(
                    child: CupertinoButton(
                  child: Text(
                    SudokuLocalizations.of(context).levelCancel,
